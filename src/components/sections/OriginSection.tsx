      ...
      <div className="about-story" ref={storyRef}>
        ...
        <div className="about-story-content">
          <p className="about-origin-story">
            ...
            <span className="about-story-beat"><StoryText text="Then I learned DaVinci Resolve to edit videos and " /><span className="about-story-icon-marker"><ResolveColorWheels isStoryActive={activeStoryIcon === 3} /></span><StoryText text=" grade them properly. " /></span>
