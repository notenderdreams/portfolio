...
export const topThoughts: { left: ThoughtAnnotation; right: ThoughtAnnotation } = {
  left: {
    ...
    doodleSrc: '/assets/doodles/arrows/arrow-11.svg',
  ...
  right: {
    ...
    doodleSrc: '/assets/doodles/arrows/arrow-13.svg',
...
export const leftFlankThoughts: ThoughtAnnotation[] = [
  {
    ...
    doodleSrc: '/assets/doodles/arrows/arrow-1.svg',
  ...
  },
  {
    ...
    doodleSrc: '/assets/doodles/arrows/arrow-14.svg',
...
export const rightFlankThoughts: ThoughtAnnotation[] = [
  {
    ...
    doodleSrc: '/assets/doodles/arrows/arrow-31.svg',
  ...
  },
  {
    ...
    doodleSrc: '/assets/doodles/misc/misc-10.svg',
